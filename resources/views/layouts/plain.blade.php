                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="/tips">Tips &amp; Trik</a></li>
                          ...
                          <li><a class="dropdown-item" href="/stress">Deteksi Stress</a></li>
                      <form action="/logout" method="POST">
                        @csrf
                       <li><button type="submit" class="dropdown-item" href="/logout"><i class="bi bi-box-arrow-right"></i>  Logout</button></li>
                      </form>
                    </ul>
                  </li>
                  <li class="nav-item">
